...
export default function Navbar() {
  ...
  return (
    <nav className="fixed bottom-14 z-10 w-[80%] left-1/2 right-1/2 -translate-x-1/2 rounded-full overflow-hidden backdrop-blur-lg bg-gray-950/30 shadow-sm md:w-[60%] p-2">
      <ul className="flex">
        {navItems.map((item) => (
          <NavList
            key={item.id}
